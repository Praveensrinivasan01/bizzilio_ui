...
const BizzilioCycle = dynamicImport(() =>
  import("../../components/ClientComponents/BizzilioCycle")
);
        ...
        <Marquee speed={50} direction="right">
          <div className="clientLogoImage">
            <div className="clientLogoIconframe">
              <img src="/assets/images/client_logo_one.svg" alt="ClientLogos" />
            </div>
            <div className="clientLogoIconframe">
              <img src="/assets/images/client_logo_two.svg" alt="ClientLogos" />
            </div>
            <div className="clientLogoIconframe ">
              <img
            ...
            <div className="clientLogoIconframe">
              {" "}
              <img src="/assets/images/client_logo_six.svg" alt="ClientLogos" />
            </div>
            <div className="clientLogoIconframe">
              <img
                className=""
